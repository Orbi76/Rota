...
<div class="col-lg-6"><div class="jumbotron">
        <div class="Table">
            ...
            <div class="jumbotron">
                ...
                <div class="Row">
                    <div class="Cell">
                        <p><?php echo $first;?> One Employee</p>
                    </div>
                    <div class="Cell" id="00">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 1){echo @$cell[$i];}	} ?>11-9</p>
                    </div>
                    <div class="Cell" id="01">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 2){echo @$cell[$i];}	} ?>11-9</p>
                    </div>
                    <div class="Cell" id="02">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 3){echo @$cell[$i];} } ?>O</p>
                    </div>
                    <div class="Cell" id="03">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 4){echo @$cell[$i];}	} ?>O</p>
                    </div>
                    <div class="Cell" id="04">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 5){echo @$cell[$i];}	} ?>O</p>
                    </div>
                    <div class="Cell" id="05">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 6){echo @$cell[$i];}	}  ?>11-9</p>
                    </div>
                    <div class="Cell" id="06">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 7){echo @$cell[$i];}	}  ?>11-9</p>
                    </div>
                </div>
                <div class="Row">
                    <div class="Cell">
                        <p><?php echo $second;?> Two Employee</p>
                    </div>
                    <div class="Cell" id="10">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 8){echo @$cell[$i];}	} ?>9-7</p>
                    </div>
                    <div class="Cell" id="11">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 9){echo @$cell[$i];}	} ?>O</p>
                    </div>
                    <div class="Cell" id="12">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 10){echo @$cell[$i];}	} ?>O</p>
                    </div>
                    <div class="Cell" id="13">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 11){echo @$cell[$i];}	} ?>O</p>
                    </div>
                    <div class="Cell" id="14">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 12){echo @$cell[$i];}	} ?>9-7</p>
                    </div>
                    <div class="Cell" id="15">
                        <p><?php for($i=0; $i<=47; $i++){if(@$cellid[$i] == 13){echo @$cell[$i];}	} ?>9-7</p>
                    </div>
                ...
                <div class="Row">
                    <div class="Cell">
                        <p><?php echo $third;?> Three Employee</p>
                    </div>
                ...
                <div class="Row">
                    <div class="Cell">
                        <p><?php echo $fourth;?> Four Employee</p>
                    </div>
                ...
                <div class="Row">
                    <div class="Cell">
                        <p><?php echo $fifth;?> Five Employee</p>
                    </div>
