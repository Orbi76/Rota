    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li><a href="insprota.php"><span class="glyphicon glyphicon-book"></span> Inspector Rota !</a></li>
                <li><a href="dirota.php"><span class="glyphicon glyphicon-book"></span> D/I Rota !</a></li>
                <li><a href="dealerrota.php"><span class="glyphicon glyphicon-book"></span> Dealer Rota !</a></li>
